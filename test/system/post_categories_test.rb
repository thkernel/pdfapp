...
class PostCategoriesTest < ApplicationSystemTestCase
  ...
  test "creating a Post category" do
    ...
    fill_in "Description", with: @post_category.description
    fill_in "Name", with: @post_category.name
    fill_in "Parent category", with: @post_category.parent_category
    fill_in "Status", with: @post_category.status
    fill_in "User", with: @post_category.user_id
